...
#define where_id(id) QString("where fid='%1'").arg(id)
#define getdb() C5Database db(__dbhost, __dbschema, __dbusername, __dbpassword)
...
public:
    ...
    explicit C5Database(const QString &host, const QString &db, const QString &user, const QString &password);
